...
export default class Category extends React.Component{
    ...
    render(){
        ...
        if(!isMobile){
            return(
                <div style={{width: 70, height: 70, cursor: "pointer", borderRadius: "200px", display: "inline-block", backgroundColor: "#DCDCDC", margin: 8}} onClick={this.onChangeLink.bind(this)}>
